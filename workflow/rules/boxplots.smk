...
rule generate_percidt_genus:
    ...
    log:
        "logs/generate_percidt_genus/{sample}.log",
    conda:
        "../envs/python.yaml"
    script:
...
rule plot_alignment_length_boxplot:
    ...
    output:
        report(
            "results/boxplots/combined_allength_boxplot.png",
    ...
    params:
        sample_name=samples,
    log:
        "logs/plot_alignment_length_boxplot/combined.log",
    conda:
        "../envs/python.yaml"
    script:
...
rule plot_percentage_identity_boxplot:
    ...
    output:
        report(
            "results/boxplots/combined_percidt_boxplot.png",
            caption="../../report/boxplot.rst",
            category="3. Boxplots",
    ...
    params:
        sample_name=samples,
    log:
        "logs/plot_percentage_identity_boxplot/combined.log",
    conda:
        "../envs/python.yaml"
    script:
...
rule plot_evalue_boxplot:
    ...
    output:
        report(
            "results/boxplots/combined_evalue_boxplot.png",
            caption="../../report/boxplot.rst",
            category="3. Boxplots",
    ...
    params:
        sample_name=samples,
    log:
        "logs/plot_evalue_boxplot/combined.log",
    conda:
        "../envs/python.yaml"
    script:
